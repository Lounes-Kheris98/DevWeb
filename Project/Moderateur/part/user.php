            ...
            echo'<ul class="collapsible col l8 m10 offset-l2 s12 offset-m1" data-collapsible="accordion">
                ...
                <div id="modal'.$i.'" class="modal">
                    ...
                    <div class="modal-footer">
                        <a href="../part/sql_rep.php?val=1&ps='.$donnees_util["email"].'&dest=1" class=" modal-action modal-close waves-effect waves-green btn-flat #4dd0e1 cyan lighten-2 white-text">Valider</a>
                   ...
                   <div id="modal'.$i.'" class="modal">
                     ...
                     <div class="modal-footer">
                       <a href="../part/sql_rep.php?val=0&ps='.$donnees_util["email"].'&dest=1" class=" modal-action modal-close waves-effect waves-green btn-flat #4dd0e1 cyan lighten-2 white-text">Valider</a>
                       <a href="" class="modal-action modal-close waves-effect waves-green btn-flat #4dd0e1 cyan lighten-2 white-text" style="margin-right:6px">Annuler</a>
                     </div>
                   </div>
                </li>
