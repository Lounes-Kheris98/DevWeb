          ...
          echo '<!--barre de menu-->
                    ...
                    <div class="nav-wrapper">
                        <div class="col s12 right-align">
                            ...
                            echo '<a  class="hide-on-small-only btn waves-effect waves-light" href="#modal2" style="margin-right:4px">deconnecter</a>
                                  ...
                                  <a href="../../Aide/" class="hide-on-small-only aide btn waves-effect waves-light">?</a>
                ...
                echo '<div id="modal2" class="modal">
                        ...
                        <div class="modal-footer">';
                          echo '<a href="../../../fonction/deconnection.php?domaine='. htmlspecialchars($_GET["domaine"]) .'&page'.$_GET["page"].'" class="white-text modal-action modal-close waves-effect waves-green btn-flat #f4511e deep-orange darken-1">deconnecter</a>';
