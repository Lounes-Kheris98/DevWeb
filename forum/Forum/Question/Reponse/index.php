<?php
    ...
    if( isset($_SESSION["type"]) && strcmp($_SESSION["type"],"a")==0 ){
      header('location: ../../../Moderateur/Forum/Question/Reponse/?domaine='. htmlspecialchars($_GET["domaine"]). '&id_quest='. htmlspecialchars($_GET["id_quest"]).'&page=1');
    }
?>
<?php
  if (isset($_GET["domaine"]) && isset($_GET["id_quest"]) && isset($_GET["page"])){
    try{
...
<?php
  ...
  echo '<!--barre de menu-->
        ...
        echo '<div id="modal2" class="modal">
                ...
                echo '<a href="../../../fonction/deconnection.php?domaine='. htmlspecialchars($_GET["domaine"]) .'&id_quest='. $_GET["id_quest"] .'" class="white-text modal-action modal-close waves-effect waves-light btn deep-light lighten-1">deconnecter</a>';
                ...
                <div id="modal1" class="modal modal-fixed-footer">
                    <form method="post" action="../../../fonction/connection.php">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="" class="cancel lighten-1 white-text modal-action modal-close waves-effect waves-light btn" style="margin-right:6px;">Annuler</a>
                        </div>
                    </form>
                </div>';
    }
...
?>
            ...
            <?php
              if(isset($_SESSION["pseudo"])){
                include("../../../fonction/listQuestConnectUser.php");
              }
              else{
                include("../../../fonction/listQuestDesconnect.php");
              }
            ?>
<?php
...
<?php
    echo'    <!--le footer pour user simple-->
