...
?>
            ...
            <nav id="breadcrumb" class="#eeeeee grey lighten-3" style="height: 44px;line-height: 24px;">
                <div class="nav-wrapper">
                  <div class="col s12 chemin">
                    ...
                    <a href="" class="breadcrumb black-text">Paramétres compte</a>
                  </div>
                </div>
            </nav>
            <style>
            ...
            <div id="info_user" style="margin-top:50px">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="form">
                        ...
                        <ul class="collapsible col l10 m10 s12 offset-l1 offset-m1" data-collapsible="accordion">
                          <li>
                            <div class="collapsible-header">
                                <span id="champAge">Age: <?php echo $donnees["age"]; ?></span>
                                <span class="badge" style="color:#039be5;">modifier<img src="../../img/pencil.png" style="width: 20px;" alt=""></span>
                            </div>
                            <div class="collapsible-body">
                                <div class="col l10 m10 s12 offset-l1 offset-m1 input-field">
                        ...
                        <div id="modal3" class="modal">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="modal-action white-text modal-close deep-light lighten-1 waves-effect waves-light btn" id="btn">Oui</button>
                                <a href="" class="modal-action modal-close white-text deep-light lighten-1 waves-effect waves-light btn" style="margin-right:6px;">Annuler</a>
                            </div>
                        </div>
